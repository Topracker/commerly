...
import { nominatimReverso, photonReverso, type Local } from '../../../lib/cidade'
...
// Reverso (coordenada -> municipio), UFs e slugify vivem em lib/cidade.ts —
// a mesma resolucao alimenta /api/loja/cidade (onde a LOJA fica).
