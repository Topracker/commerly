          ...
          <div className="flex flex-col gap-4">
            {senhaRecusada ? (
              <>
                ...
                <CampoSenha id="retry-entregador" value={senha} onChange={setSenha} onEnter={salvarSenhaRecusada}
                  placeholder="Nova senha *" className={inp} />
                <button onClick={salvarSenhaRecusada} disabled={loading || !senhaValida(senha)} className={btn}>
