      ...
      <div className="bg-gray-900 rounded-3xl p-8 w-full max-w-sm">
        <div className="mb-6">
          ...
          <p className="text-gray-400">
            {etapa === 'email' ? 'Descubra comércios locais' : 'Verifique seu e-mail'}
          </p>
        </div>
        ...
        {etapa === 'email' ? (
          ...
          <div className="flex flex-col gap-4">
            ...
            <input
              ...
              maxLength={6}
              autoFocus
              className="bg-gray-800 text-white rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-500 text-center text-2xl tracking-widest"
            />
            <button
              onClick={verificar}
              disabled={loading}
